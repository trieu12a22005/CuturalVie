      ...
      >
        ...
        <div className="absolute top-[38%] left-[52%] translate-x-[-50%] text-[18px] font-semibold w-[650px]">
          <p className="">
            ...
            trải qua 10 câu hỏi, mỗi câu hỏi cung cấp một từ với những chữ cái
            bị thiếu. Nhiệm vụ của bạn là điền vào các chữ cái còn thiếu để tạo
            thành từ đúng nghĩa. Sau mỗi câu hỏi, bạn sẽ được cung cấp thêm
            thông tin bổ ích để mở rộng vốn từ của mình.
            <br />
            Cách chơi: <br />
            ...
            7/10 câu.
            <br />
            Chúc bạn may mắn và thành công trong hành trình khám phá mã lệnh
            này!
          </p>
          <button
            className="mt-[20px] flex ml-[250px] bg-[#009951] p-[10px] pl-[20px] pr-[20px] rounded-2xl text-white font-bold"
            onClick={handleClick}
          >
            Chơi ngay
          </button>
