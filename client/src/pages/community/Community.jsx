...
const Community = () => {
    ...
    const handleEditPost = (postId) => {
        ...
        window.location.href = `/community/edit-post/${postId}`;
    };
    ...
    const handleDeletePost = async (postId) => {
        ...
        try {
            await axiosInstance.delete('/post/delete-post?postId=' + postId);
                            ...
                            <div key={post.id} className="mb-8">
                                ...
                                <div className="mt-4 bg-gray-50 p-4 rounded-lg">
                                    ...
                                    {!loadingCommentsMap[post.id] && commentsMap[post.id]?.map((comment) => (
                                        <Comment
                                            key={comment.id}
                                            avatar={comment.user?.avatar_url || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeJF7sVh67zp0MmU1w8UaRV9j_vZ0v9-ecYA&s"}
                                    ...
                                    <div className="mt-4 flex items-start gap-3">
                                        <img
                                            src={user?.avatar_url || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeJF7sVh67zp0MmU1w8UaRV9j_vZ0v9-ecYA&s"}
